...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"game-module-v1.js":[function(require,module,exports) {
"use strict";
...
const Game = (gameName, numberOfTurns) => {
  // the state    
  const name = gameName;
  ...
  const removePlayer = player => {
    ...
    console.log(initialLength + players);
...
},{}],"gameTest.js":[function(require,module,exports) {
"use strict";

var _gameModuleV = require("./game-module-v1");

var _player = require("./player");

let game = (0, _gameModuleV.Game)("SuperGame", 10);
console.log(game.toString());
game.currentTurn = 50;
let player1 = (0, _player.Player)(1);
player1.setScore(5);
console.log(player1.getId());
game.addPlayer(player1);
console.log(game.toString());
let player2 = (0, _player.Player)(2);
player2.setScore(5);
game.addPlayer(player2);
console.log(game.toString()); //expect( game.getNoOfPlayers(), 2)

let player3 = (0, _player.Player)(3);
player3.setScore(3);
...
},{"./game-module-v1":"game-module-v1.js","./player":"player.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","gameTest.js"], null)
//# sourceMappingURL=/gameTest.ed85d391.js.map