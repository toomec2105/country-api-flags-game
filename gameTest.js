...
class Game {
  ...
  removePlayer(playerID) {/// players.filter(); in array methods

    /* if(){
     }else{
        throw new Error("Can not find player with id: " + playerID);
    } */
  }
  ...
  getWinnerID() {//przeleciec przez array playerow i sprawdzic ktory ma najwyzszy score
  }

  isDraw() {//if 2 players have same highest score return true
  }

  toString() {
    return "name: " + this.name + "noOfTurns: " + this.noOfTurns + "currTurn" + this.currentTurn + "currPlayerID; " + this.currentPlayerID + "\nplayers: " + this.players;
  }
...
let game = new _game.Game("Super Game", 10);
